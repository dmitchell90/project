...
/**
 * Dies ist ein Bestätigungsfenster, welches kommt, wenn ein Artikel erfolgreich bearbeitet wurde
 * 
...
public class FrameArtikelBearbeitet extends JFrame implements ActionListener{
	...
	JLabel labelBestaetigung = new JLabel (" Alle Änderungen wurden gespeichert",JLabel.CENTER);
